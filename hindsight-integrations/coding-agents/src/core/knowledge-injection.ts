...
const TOOL_GUIDE =
  ...
  "snippet in your own words does not make it yours. If the results genuinely did not bear on the " +
  "turn, say so in one line instead — a search that found nothing useful is worth reporting too.\n" +
