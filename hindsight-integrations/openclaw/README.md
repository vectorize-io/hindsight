...
| `sharedEvidenceEnabled`    | `false`                        | Also recall a small, read-only evidence set from `sharedEvidenceBankId`. This feature never writes to that bank.                                                                                                                                                                                             |
| `sharedEvidenceBankId`     | —                              | Optional bank containing shared evidence such as organization-wide policies or a user-approved profile.                                                                                                                                                                                                      |
| `sharedEvidenceMaxTokens`  | `700`                          | Max tokens requested from the shared evidence bank.                                                                                                                                                                                                                                                          |
| `sharedEvidenceTopK`       | `2`                            | Max shared-evidence memories injected per turn.                                                                                                                                                                                                                                                               |
| `sharedEvidenceTimeoutMs`  | `recallTimeoutMs`              | Optional per-call timeout for shared evidence recall.                                                                                                                                                                                                                                                         |
