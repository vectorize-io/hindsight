...
| `boost_by_usefulness` | bool | false | Boost results by [usefulness signals](./feedback-signals) |
| `usefulness_weight` | float | 0.3 | Weight for usefulness boost (0.0-1.0) |
| `min_usefulness` | float | 0.0 | Filter facts below this usefulness score |
