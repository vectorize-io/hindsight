...
:::tip
This is the free counterpart to [dry-run extraction](/developer/api/memories), which spends a real LLM call to show what a candidate mission would actually *extract*. Preview the prompt first, then dry-run it.
:::
