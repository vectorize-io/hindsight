...
[View Changelog →](/changelog/integrations/omnigent)
...
- [Blog post: Give every agent you run in Omnigent a persistent memory](/blog/2026/07/14/omnigent-persistent-memory)
