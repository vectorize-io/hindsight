...
description: "Add long-term memory to Cursor with Hindsight. Automatically recalls relevant context at session start and before each prompt, then retains conversations after each task."
---
