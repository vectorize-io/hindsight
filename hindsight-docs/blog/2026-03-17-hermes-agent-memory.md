...
:::warning Deprecated
The `hindsight-hermes` pip plugin described in this post is deprecated. Hermes now ships with a native Hindsight memory provider. See [Hindsight Is Now a Native Memory Provider in Hermes Agent](/blog/2026/04/02/hermes-native-memory-provider) for the current setup guide.
:::
