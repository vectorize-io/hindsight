...
Hindsight now integrates with PydanticAI, letting you attach persistent memory to any PydanticAI agent with a few lines of code.
...
Observations are Hindsight's higher-level summaries derived from raw facts. Previously, observations were always consolidated across all tags at once. Now you can control the granularity of each consolidation pass with `observation_scopes`.
...
- Queries like "What does Alice struggle with?" and "How does Bob teach?" match.
