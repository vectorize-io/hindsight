...
Type-safe access prevents accidentally using global defaults when bank overrides exist. See the [Configuration Guide](/docs/developer/configuration#hierarchical-configuration) for details.
