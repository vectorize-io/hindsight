...
description: "Add long-term memory to AutoGen agents with Hindsight. Provides FunctionTool instances that plug directly into AutoGen AssistantAgent with fact extraction and temporal awareness."
---
