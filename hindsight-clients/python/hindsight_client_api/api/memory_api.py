...
from hindsight_client_api.models.semantic_candidates_request import SemanticCandidatesRequest
...
class MemoryApi:
    ...
    async def retrieve_semantic_candidates(
        self,
        bank_id: StrictStr,
        semantic_candidates_request: SemanticCandidatesRequest,
        authorization: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param bank_id: (required)
        :type bank_id: str
        :param semantic_candidates_request: (required)
        :type semantic_candidates_request: SemanticCandidatesRequest
        :param authorization:
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._retrieve_semantic_candidates_serialize(
            bank_id=bank_id,
            semantic_candidates_request=semantic_candidates_request,
            authorization=authorization,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def retrieve_semantic_candidates_with_http_info(
        self,
        bank_id: StrictStr,
        semantic_candidates_request: SemanticCandidatesRequest,
        authorization: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SemanticCandidatesResponse]:
        """Retrieve semantic candidates
    ...
    @validate_call
    async def retrieve_semantic_candidates_without_preload_content(
        self,
        bank_id: StrictStr,
        semantic_candidates_request: SemanticCandidatesRequest,
        authorization: Optional[StrictStr] = None,
    ...
    def _retrieve_semantic_candidates_serialize(
        self,
        bank_id,
        semantic_candidates_request,
        authorization,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if semantic_candidates_request is not None:
            _body_params = semantic_candidates_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/default/banks/{bank_id}/memories/semantic-candidates',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
