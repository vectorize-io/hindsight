...
class FeaturesInfo(BaseModel):
    ...
    server_llm_config_api: StrictBool = Field(description="Whether the instance-level LLM configuration API is enabled (single-tenant self-host)")
    ...
    __properties: ClassVar[List[str]] = ["observations", "mcp", "worker", "bank_config_api", "server_llm_config_api", "bank_llm_health", "file_upload_api", "document_export_api", "document_import_api", "audit_log", "llm_trace", "store_document_text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "server_llm_config_api": obj.get("server_llm_config_api"),
