...
class ImageAssetDescriptor(BaseModel):
    ...
    created_at: datetime
    updated_at: datetime
    __properties: ClassVar[List[str]] = ["asset_id", "mime_type", "size_bytes", "sha256", "width", "height", "status", "document_ids", "created_at", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImageAssetDescriptor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImageAssetDescriptor from a dict"""
        if obj is None:
            return None
