...
class MentalModelTriggerInput(BaseModel):
    ...
    full_refresh_interval: Optional[Union[StrictStr, StrictInt, StrictFloat]] = None
    ...
    __properties: ClassVar[List[str]] = ["mode", "refresh_after_consolidation", "refresh_cron", "full_refresh_interval", "fact_types", "exclude_mental_models", "exclude_mental_model_ids", "tags_match", "tag_groups", "include_chunks", "recall_max_tokens", "recall_chunks_max_tokens"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if full_refresh_interval (nullable) is None
        # and model_fields_set contains the field
        if self.full_refresh_interval is None and "full_refresh_interval" in self.model_fields_set:
            _dict['full_refresh_interval'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "full_refresh_interval": obj.get("full_refresh_interval"),
