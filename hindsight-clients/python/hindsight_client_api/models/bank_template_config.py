...
class BankTemplateConfig(BaseModel):
    ...
    retain_image_chunk_cost_chars: Optional[StrictInt] = None
    retain_max_images_per_chunk: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["reflect_mission", "retain_mission", "retain_extraction_mode", "retain_custom_instructions", "retain_chunk_size", "retain_structured_chunk_size", "enable_observations", "observations_mission", "enable_text_search", "enable_temporal_retrieval", "enable_graph_retrieval", "enable_reranking", "disposition_skepticism", "disposition_literalism", "disposition_empathy", "entity_labels", "entities_allow_free_form", "retain_default_strategy", "retain_strategies", "retain_chunk_batch_size", "retain_image_chunk_cost_chars", "retain_max_images_per_chunk", "mcp_enabled_tools", "consolidation_llm_batch_size", "consolidation_source_facts_max_tokens", "consolidation_source_facts_max_tokens_per_observation", "max_observations_per_scope", "observation_scope_limits", "reflect_source_facts_max_tokens", "mental_model_min_refresh_interval_seconds", "llm_gemini_safety_settings", "recall_budget_function", "recall_budget_fixed_low", "recall_budget_fixed_mid", "recall_budget_fixed_high", "recall_budget_adaptive_low", "recall_budget_adaptive_mid", "recall_budget_adaptive_high", "recall_budget_min", "recall_budget_max", "audit_log_enabled", "store_document_text", "enable_auto_consolidation", "consolidation_max_memories_per_round", "consolidation_llm_parallelism", "recall_include_chunks", "recall_max_tokens", "recall_chunks_max_tokens", "memory_defense"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if retain_image_chunk_cost_chars (nullable) is None
        # and model_fields_set contains the field
        if self.retain_image_chunk_cost_chars is None and "retain_image_chunk_cost_chars" in self.model_fields_set:
            _dict['retain_image_chunk_cost_chars'] = None

        # set to None if retain_max_images_per_chunk (nullable) is None
        # and model_fields_set contains the field
        if self.retain_max_images_per_chunk is None and "retain_max_images_per_chunk" in self.model_fields_set:
            _dict['retain_max_images_per_chunk'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "retain_image_chunk_cost_chars": obj.get("retain_image_chunk_cost_chars"),
            "retain_max_images_per_chunk": obj.get("retain_max_images_per_chunk"),
