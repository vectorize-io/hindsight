...
class BankTemplateConfig(BaseModel):
    ...
    backup_enabled: Optional[StrictBool] = None
    backup_retention_days: Optional[Annotated[int, Field(le=7, strict=True, ge=1)]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if backup_enabled (nullable) is None
        # and model_fields_set contains the field
        if self.backup_enabled is None and "backup_enabled" in self.model_fields_set:
            _dict['backup_enabled'] = None

        # set to None if backup_retention_days (nullable) is None
        # and model_fields_set contains the field
        if self.backup_retention_days is None and "backup_retention_days" in self.model_fields_set:
            _dict['backup_retention_days'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "backup_retention_days": obj.get("backup_retention_days"),
