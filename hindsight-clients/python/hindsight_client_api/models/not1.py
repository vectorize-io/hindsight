...
NOT1_ANY_OF_SCHEMAS = ["TagGroupAndOutput", "TagGroupEntityLeaf", "TagGroupLeaf", "TagGroupNotOutput", "TagGroupOrOutput"]
...
class Not1(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Not1 with anyOf schemas: TagGroupAndOutput, TagGroupEntityLeaf, TagGroupLeaf, TagGroupNotOutput, TagGroupOrOutput. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Not1 with anyOf schemas: TagGroupAndOutput, TagGroupEntityLeaf, TagGroupLeaf, TagGroupNotOutput, TagGroupOrOutput. Details: " + ", ".join(error_messages))
        else:
            return instance
