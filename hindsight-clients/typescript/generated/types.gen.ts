...
export type UpdateMentalModelRequest = {
   ...
   * Content
   *
   * New content for the mental model, set directly (e.g. to restore a previous version from mental-model history) rather than generated by a refresh. Recomputes the embedding, records the previous content in mental_model_history, and advances last_refreshed_at (see MemoryEngine.update_mental_model).
   */
  content?: string | null;
  /**
   * Source Query
