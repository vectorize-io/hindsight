...
func (o *MentalModelTriggerOutput) GetDeltaFastPath() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *MentalModelTriggerOutput) GetDeltaFastPathOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *MentalModelTriggerOutput) HasDeltaFastPath() bool {
