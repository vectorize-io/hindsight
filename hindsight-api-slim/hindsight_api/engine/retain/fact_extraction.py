...
_DEFAULT_LANGUAGE_RULE = """LANGUAGE: Write every fact in the input text's own language and script. Never translate, never switch language. Names, identifiers, code, and quoted text stay verbatim."""
