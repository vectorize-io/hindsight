...
class Embeddings(ABC):
    ...
    def _encode_batched(
        ...
        *,
        ...
        executor = ThreadPoolExecutor(max_workers=concurrency, thread_name_prefix="hs-embed")
        try:
            ...
            futures: list[Future[list[list[float]]]] = [
                executor.submit(run_in_context, contextvars.copy_context(), batch) for batch in batches
            ]
