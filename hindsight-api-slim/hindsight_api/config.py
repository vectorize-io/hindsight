...
ENV_WORKER_ORPHAN_LEASE_SECONDS = "HINDSIGHT_API_WORKER_ORPHAN_LEASE_SECONDS"
...
# Age after which a 'processing' row owned by a departed worker is reclaimed.
# 24 h is far beyond any real task; 0 disables the sweep. See poller.
DEFAULT_WORKER_ORPHAN_LEASE_SECONDS = 86400
...
class HindsightConfig:
    ...
    worker_orphan_lease_seconds: int
    ...
    def from_env(cls) -> "HindsightConfig":
        ...
        config = cls(
            ...
            worker_orphan_lease_seconds=int(
                os.getenv(ENV_WORKER_ORPHAN_LEASE_SECONDS, str(DEFAULT_WORKER_ORPHAN_LEASE_SECONDS))
            ),
