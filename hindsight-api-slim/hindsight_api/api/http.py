...
class MentalModelTrigger(BaseModel):
    ...
    mode: Literal["full", "delta"] | None = Field(
        default=None,
        description=(
            "Refresh mode. 'full' regenerates the mental model content from scratch on each refresh. "
            ...
            "regeneration automatically. When omitted (null), the server default applies "
            "(HINDSIGHT_API_DEFAULT_MENTAL_MODEL_REFRESH_MODE, itself defaulting to 'full')."
        ),
    )
