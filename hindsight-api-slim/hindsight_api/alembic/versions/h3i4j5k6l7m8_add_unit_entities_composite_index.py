"""add_unit_entities_composite_index

Revision ID: h3i4j5k6l7m8
Revises: a4b5c6d7e8f9, c2d3e4f5g6h7, g2h3i4j5k6l7
Create Date: 2026-04-07

Add composite index (entity_id, unit_id) on unit_entities to enable index-only
scans for the LATERAL entity expansion query in link_expansion_retrieval.py.
The old single-column idx_unit_entities_entity(entity_id) is now redundant
and is dropped.
"""
