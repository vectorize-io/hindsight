...
async def tool_learn(
    ...
    if existing:
        ...
        await conn.execute(
            """
            INSERT INTO mental_models (id, bank_id, type, subtype, name, description, summary, triggers, entity_id, last_updated, created_at)
            VALUES ($1, $2, $3, 'learned', $4, $5, $6, $7, $8, NOW(), NOW())
            """,
            model_id,
            bank_id,
            input.type.value,
