...
| `include_data` | `true` | Copy the memories and everything backing them. |
| `include_bank_config` | `true` | Copy bank config, mental models and their history, knowledge pages, directives and webhooks. |
