...
```bash
# Step 1: Clear the content
curl -X POST "$BASE_URL/v1/default/banks/$BANK_ID/mental-models/$MODEL_ID/clear"

# Step 2: Trigger a fresh rebuild
curl -X POST "$BASE_URL/v1/default/banks/$BANK_ID/mental-models/$MODEL_ID/refresh"
```
