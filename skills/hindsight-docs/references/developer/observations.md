...
To see which strategy a scope uses, open the strategy in the control plane: next to each matching scope, it shows whether this strategy wins it or an earlier one does.
